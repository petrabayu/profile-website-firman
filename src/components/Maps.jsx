...
const Maps = () => {
  return (
    <>
      <div className="p-6">
        <h2 className="text-[40px] text-center font-bold leading-none mb-6">
          Tempat Bekerja
        </h2>
        <div className="relative w-full pb-[56.25%] h-[500px] overflow-hidden rounded-3xl border-8 border-green-500">
          <iframe
